...
export const offer: OfferContent = {
  plate: 'scale',
  heading: 'Six months at zero Thinq brokerage.',
  summary:
    'Equity, futures and options, from the day your account is activated. No tiers, no minimum turnover. Statutory charges apply and are not ours to waive: STT, exchange transaction charges, SEBI turnover fee, GST and stamp duty. It belongs to the list, and the list closes when we open.',
  terms: [
